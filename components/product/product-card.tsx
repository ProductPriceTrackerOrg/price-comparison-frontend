...
import { Heart, Store, Eye, Share2, TrendingUp, TrendingDown, Star, Clock, Users, Zap } from "lucide-react"
    ...
    >
      ...
      <CardContent className="p-0 flex flex-col h-full relative z-10">
        ...
        <div className="p-5 flex flex-col flex-grow space-y-4">
          ...
          {(product.searchVolume || product.preOrders || product.priceChange) && (
          ...
          <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-xl border border-gray-100">
            ...
            <span className="text-sm font-medium text-gray-700 truncate flex-1">{product.retailer}</span>
