        ...
        try {
          ...
          if (data.session && data.user) {
            ...
            toast({
              ...
              description: "Welcome to PricePulse! Your account is now active and you're signed in.",
            });
          ...
          toast({
            ...
            description: error.message || "Failed to confirm your email. Please try again or contact support.",
            variant: "destructive",
          });
          setIsProcessing(false);
          router.push('/');
